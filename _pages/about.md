...
I'm especially interested in how can we push the boundaries of making the output of a camera closer to what we see. I also work with extrating 3D information from images.

I obtained my PhD on [Differentiable Formulations for Inverse Rendering](/assets/pdf/hannemosePhDthesis.pdf) in 2020 under the supervision of [Jeppe Revall Frisvad](https://people.compute.dtu.dk/jerf/) and [Jakob Wilm](https://portal.findresearcher.sdu.dk/da/persons/jaw). 
